...
Like JavaScript, hson also provides array and object _destructuring_ for accessing array indices and object properties. The following script produces the same result as above ("Smashing Sushi") but instead utilizes destructuring for index and property access.
