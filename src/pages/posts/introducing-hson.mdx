...
As previously mentioned, an hson program comprises a series of zero or more variable declarations followed by a single expression, as illustrated by the following type definition.
...
The Haskell parser is implemented using the [Parsec](https://hackage.haskell.org/package/parsec-3.1.17.0/docs/Text-Parsec.html) library, which contains types and primitives for composing monadic parser combinators.[^3]
